...
automatically logs any typed content into Cypress's command log.
...
allow you to mask sensitive data in Cypress's command log.
...
Now our sensitive password is not printed to Cypress's command log when
