...
- `cy.request()` requires being chained off of
...
or `3xx` when `failOnStatusCode` is `true`.

### Assertions [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Assertions)

- `cy.request()` will only run assertions you have chained once, and
will not [retry](/guides/core-concepts/retry-ability).

### Timeouts [<Icon name="question-circle"/>](/guides/core-concepts/introduction-to-cypress#Timeouts)

- `cy.request()` can time out waiting for the server to
respond.
