...
Clone the <Icon name="github" inline="true" rwa="true" /> and refer to the [bitbucket-pipelines.yml](https://github.com/cypress-io/cypress-realworld-app/blob/develop/bitbucket-pipelines.yml) file.
