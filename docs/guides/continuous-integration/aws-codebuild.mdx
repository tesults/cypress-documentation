...
Clone the <Icon name="github" inline="true" rwa="true" /> and refer to the [buildspec.yml](https://github.com/cypress-io/cypress-realworld-app/blob/develop/buildspec.yml) file.
